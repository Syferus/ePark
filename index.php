        ...
        <div class="col-md-9">
            ...
            <div id="location">
                ...
                <script>
                    ...
                    function TestRes() {
                        num++;
                        toastr["info"]("Taking Picture, Please Wait");
                    ...
                    function Node(x, y) {
                        ...
                        function drawSprite() {
                            circle.graphics.clear().beginFill(circle._fill).drawCircle(0, 0, 5);
                        }
                    ...
                    function Cancel() {
                        resetDraw();
                        stage.update();
                        toastr["warning"]("Space not saved");
                    ...
                    function init() {
                        ...
                        points[0] = [nodes.children[0].x, nodes.children[0].y];
                        points[1] = [nodes.children[1].x, nodes.children[1].y];
                        points[2] = [nodes.children[2].x, nodes.children[2].y];
                        points[3] = [nodes.children[3].x, nodes.children[3].y];
                    ...
                    function GridMaths() {
                        ...
                        var SinA = Math.sin(AngleA) * Per_Frame_DistanceA;
                        var CosA = Math.cos(AngleA) * Per_Frame_DistanceA;

                        var AngleB = Math.atan2(points[2][1] - points[1][1], points[2][0] - points[1][0]);
                        var Per_Frame_DistanceB = distB / times;
                        var SinB = Math.sin(AngleB) * Per_Frame_DistanceB;
                        var CosB = Math.cos(AngleB) * Per_Frame_DistanceB;

                        var AngleC = Math.atan2(points[3][1] - points[2][1], points[3][0] - points[2][0]);
                        var Per_Frame_DistanceC = distC / times;
                        var SinC = Math.sin(AngleC) * Per_Frame_DistanceC;
                        var CosC = Math.cos(AngleC) * Per_Frame_DistanceC;

                        var AngleD = Math.atan2(points[3][1] - points[0][1], points[3][0] - points[0][0]);
                        var Per_Frame_DistanceD = distD / times;
                        var SinD = Math.sin(AngleD) * Per_Frame_DistanceD;
                        var CosD = Math.cos(AngleD) * Per_Frame_DistanceD;
                    ...
                    function success() {
                        ...
                        if (allPoints.length != 0) {
                            ...
                            document.getElementById("pNoPoints").innerText = "*No Space's Setup";
                        }
                    }
                ...
                <script
                    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDfhqrp6LNGphqO1xUNQJkLuFd0IPgmb8&&region=IE&callback=initMap"
                    async defer></script>
                <br/>
                <input type="button" id="getAddr" class="btn btn-success" value="Select Location"
                       onclick="GetAddress()"/>
                <br/>
                <div id="fin" hidden="hidden">
                    ...
                    <br/>
                    <input type="button" id="saveLocation" class="btn btn-success" value="Save" disabled
            ...
            <div id="resolution" hidden="hidden">
                <h3>Resolution</h3>
                <h4>Please Select a Resolution.</h4>
                ...
                <br/>
                <input type="button" value="Take Picture" id="testRes" class="btn btn-success" onclick="TestRes()"/>
                <div id="output"></div>
                <br/>
                <br/>
                <div id="imgdiv" hidden="hidden">
                    ...
                    <br/>
                    <br/>
                    <input type="button" value="Save Picture" class="btn btn-success" onclick="SaveResolution()"/>
                </div>
            </div>

            <div id="frequency" hidden="hidden">
                <h3>Frequency</h3>
                <h4>Please Select How often the Parking Spaces are to be updated.</h4>
            ...
            <div id="Cutting" hidden="hidden">
                ...
                <button class="btn btn-primary" onclick="init()">Show</button>
                ...
                <button type="button" class="btn btn-info"
                        ...
                        title="How To"
                        data-content="<ul>
						<li>Click on the 4 corners of a parking space.</li>
						<li>Drag the points for fine tuning.</li>
						<li>Click Show to highlight that parking space.</li>
						<li>To save that space, Click the Save button.</li>
						<li>Add a new space by repeating the previous steps.</li>
						<li>When all spaces are done, Click the Finish button</li>
						</ul>">How To
                </button>
                <br/><br/>
                <div class="container">
                ...
                <p id="pNoPoints" class="text-danger" style="font-size:15px;"></p>
            </div>

            <div id="Finish" hidden="hidden">
                <h3>Setup Complete</h3>
                <h4>Your Car Park is Now Live.</h4>
            </div>
        </div>
    </div>
</div>
